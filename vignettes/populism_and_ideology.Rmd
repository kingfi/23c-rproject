...
Our scatterplot shows axis means with dotted lines and a linear regression, shown in red. Confirming our results above, there doesn't seem to be any correlation between economic ideology and populism.
